...
class MergeTest
{
    ...
    public static void main(String[] args) throws JampackException
    {
        ...
        B = Merge.o23(A.get(bx, 5, bx, 3), A.get(bx, 5, 4, 6), A.get(bx, 5, 7, cx), A.get(6, rx, bx, 3),
                A.get(6, rx, 4, 6), A.get(6, rx, 7, cx));
        Print.o(Norm.fro(Minus.o(A, B)));

        B = Merge.o31(A.get(bx, 3, bx, cx), A.get(4, 6, bx, cx), A.get(7, rx, bx, cx));
        Print.o(Norm.fro(Minus.o(A, B)));

        B = Merge.o32(A.get(bx, 3, bx, 5), A.get(bx, 3, 6, cx), A.get(4, 6, bx, 5), A.get(4, 6, 6, cx),
                A.get(7, rx, bx, 5), A.get(7, rx, 6, cx));
        Print.o(Norm.fro(Minus.o(A, B)));

        B = Merge.o33(A.get(bx, 3, bx, 3), A.get(bx, 3, 4, 6), A.get(bx, 3, 7, cx), A.get(4, 5, bx, 3),
                A.get(4, 5, 4, 6), A.get(4, 5, 7, cx), A.get(6, rx, bx, 3), A.get(6, rx, 4, 6), A.get(6, rx, 7, cx));
        Print.o(Norm.fro(Minus.o(A, B)));
