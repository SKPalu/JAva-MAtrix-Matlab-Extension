 ...
 * The basic method (Merge.o) takes an array of Zmat's and merges them. For
 * conformity, the Zmats along a row of the array must have the same number of
 * rows, and the Zmats along a column of the array must have the same number of
 * columns.
 * <p>
 * For convenience a number of special routines (o12, o21, o22, o13, ...) are
 * provided to merge the matrices in their argument list.
 * 
 * @version Pre-alpha
 * @author G. W. Stewart
 */
...
public class Merge
{
    ...
    public static Zmat o(Zmat[][] B) throws JampackException
    {
        ...
        /*
         * Compute the number of columns in the result while testing for
         * columnwise conformity.
         */
        ...
        /*
         * Compute the number of rows in the result while testing for rowwise
         * conformity.
         */
