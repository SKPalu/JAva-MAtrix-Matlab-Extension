...
/**
 * Block contains a static method for partitioning a matrix. into a block
 * matrix.
 * 
 * @version Pre-alpha
 * @author G. W. Stewart
...
public class Block
{
    ...
    /**
     * This method takes a Zmat A and two arrays ii and jj of length m and n and
     * produces an (m-1)x(n-1) block matrix Zmat[m-1][n-1], whose (i,j)-element
     * is A.get(ii[i], ii[i+1]-1, jj[j], jj[j+1]-1). Throws a JampackException
     * if
     * 
     * @param A
