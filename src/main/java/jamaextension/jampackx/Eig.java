 ...
 * Specifically given a diagonalizable matrix A, there is a matrix nonsingular
 * matrix X such that
 * 
 * <pre>
 *      D = X<sup>-1</sup> AX
 ...
 * eigevectors. However, the matrix X will be ill conditioned.
 * 
 * @version Pre-alpha
 * @author G. W. Stewart
 */
