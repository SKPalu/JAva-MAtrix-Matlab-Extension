...
/**
 * The rand suite generates random objects with elements distributed randomly on
 * [0,1] or normally with mean zero and standard deviation one.
 * 
 * @version Pre-alpha
 * @author G. W. Stewart
 */
...
public class Rand
{
    ...
    /**
     * Generates a uniform random complex number, i.e., a complex number whose
     * real and imaginary parts are random.
     * 
    ...
    /**
     * Generates a normal random complex number, i.e., a complex number whose
     * real and imaginary parts are random.
     * 
