...
/**
 * Zludpp implements the LU decomposition with partial pivoting. Specifically,
 * given a matrix A, there is a permunation matrix P, a unit lower triangular
 * matrix L whose subdiagonal elements are less than one in magnitude and a
...
public class Zludpp
{
    ...
    public Zludpp(Zmat A) throws JampackException
    {
        ...
        /*
         * Set up the matrix T in which the elimination will be performed and
         * copy A to it.
         */
