 ...
 * <p>
 * 
 * The functions are reasonably resistent to overflow and underflow. But the
...
public class Z
{
    ...
    /**
     * Computes the quotient of two Z's. Throws a JampackException if the
     * denominator is zero.
     * 
     * @param a
     *            a Z
    ...
    /**
     * Computes the quotient of a Z and a double. Throws a JampackException if
