package jamaextension.jampackx;

/**
 * Rot generates and manipulates plane rotations. Given a 2-vector compontents
...
public class Rot
{
    ...
    /**
     * Given the real and imaginary parts of a 2-vector, genc returns a plane
    ...
    /**
     * Given a Zmat A, genc returns a plane rotation that on premultiplication
     * into rows ii1 and ii2 annihilates A(ii2,jj). The element A(ii2,jj) is
     * overwriten by zero and the element A(ii1,jj) is overwritten by its
     * transformed value.
     * 
     * @param A
     *            The Zmat (altered)
    ...
    /**
     * Given the real and imaginary parts of a 2-vector, genr returns a plane
     * rotation such that
     * 
     * <pre>
     *      |x y|P = |x y||   c      s||x| = |z 0|
    ...
    /**
     * Given the real and imaginary parts of a 2-vector, genr generates a plane
     * rotation such that
     * 
     * <pre>
     *      |x y|P = |x y||   c      s||x| = |z 0|
    ...
    /**
     * Given a Zmat A, genr returns a plane rotation that on postmultiplication
     * into column jj1 and jj2 annihilates A(ii,jj2). The element A(ii,jj2) is
     * overwirten by zero and the element A(ii,jj1) is overwritten by its
     * transformed value.
     * 
     * @param A
     *            The Zmat (altered)
     * @param ii
     *            The index of the row containing the elements
     * @param jj1
     *            The column index of the first element
     * @param jj2
     *            The column index of the second element (the one that is
     *            annihilated)
     * @return The rotation
     */
     ...
     * postmultiplication into column jj1 and jj2 annihilates A(ii,jj2). The
     * element A(ii,jj2) is overwirten by zero and the element A(ii,jj1) is
    ...
    /**
     * Multiplies rows (ii1,jj1:jj2) and (ii2,jj1:jj2) of a Zmat (altered) by
     * the conjugate transpose of a plane rotation.
     * 
     * @param P
     *            The plane rotation
     * @param A
