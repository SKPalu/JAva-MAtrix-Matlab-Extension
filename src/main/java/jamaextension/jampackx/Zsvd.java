...
/**
 * Zsvd implements the singular value decomposion of a Zmat. Specifically if X
 * is an mxn matrix with m&gt;=n there are unitary matrices U and V such that
 * 
 * <pre>
 *     U^H*X*V = | S |
 *               | 0 |
...
public class Zsvd
{
    ...
    /**
     * Computes the SVD of a Zmat XX. Throws a JampackException if the maximum
