 ...
 * <p>
 * Comments: Inv computes the inverse of A by using Solve to solve the system AX
 * = I. This is inefficient, though not inordinately so. Eventually these
 * methods will be replaced.
 * 
 * @version Pre-alphs
 * @author G. W. Stewart
 */
