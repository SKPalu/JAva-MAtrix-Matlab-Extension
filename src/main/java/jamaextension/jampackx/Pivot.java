...
/**
 * Pivot applys a sequence of pivot operations to the rows of a matrix. The
 * pivot sequence is contained in an integer array pvt[], which determines a
 * permution as follows:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * Both k and pvt[k] represent zero-based references to the rows of the matrix.
...
public class Pivot
{
    ...
    /**
     * Pivots the rows of a Zmat (altered) as in the inverse order specified by
     * a pivot array.
     * 
     * @param A
     *            The Zmat (altered)
