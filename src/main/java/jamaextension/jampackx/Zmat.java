...
public class Zmat
{
    ...
    /**
     * Points to a Householder QR decompoistion of the matrix provided one
     * exists
     */
    protected Zhqrd HQR;
    ...
    /**
     * Returns an LU decomposition if a valid one exists. Otherwise returns
     * null.
     */
    ...
    /**
     * Returns a Householder QR decomposition if a valid one exists. Otherwise
     * returns null.
     */
    ...
    /**
     * Returns a Cholesky decomposition if a valid one exists. Otherwise returns
     * null.
     */
    ...
    /**
     * Nullifies the history pointers if the matrix is dirty and sets the dirty
     * flag to false.
     */
