...
/**
 * 
 * The use of this class is restricted to this package only.
 * 
 * @author Sione
 */
class QsortMatrixWithIndices
{
    ...
    QsortMatrixWithIndices(Matrix A, Indices B, Dimension D, boolean allowIndSort)
    {
        String msg = "";
        if (A == null)
        {
    ...
    protected void setM(int i, int j, double doubleVal)
    {
    ...
    protected void setElementAtM(int i, double doubleVal)
    {
    ...
    protected double getElementAtM(int i)
    {
