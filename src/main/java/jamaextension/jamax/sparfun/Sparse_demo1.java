 ...
 * 
 */
public class Sparse_demo1
{

    public static void main(String[] args)
    {
        Sparse T = null, A, Eye, AT, C, D;
        int i, m;
        if (args.length == 0)
        {
        ...
        T = Dcs_util.cs_spalloc(m, m, m, true, true); /*
                                                       * create triplet identity
                                                       * matrix
                                                       */
        for (i = 0; i < m; i++)
        {
        ...
        D = Dcs_add.cs_add(C, Eye, 1, Dcs_norm.cs_norm(C)); /*
                                                             * D = C + Eye*norm
                                                             * (C,1)
                                                             */
        System.out.print("D:\n");
