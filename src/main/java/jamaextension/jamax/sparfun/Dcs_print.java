...
public class Dcs_print
{
    ...
    public static boolean cs_print(Sparse A)
    {
        return cs_print(A, false);
    }

    public static boolean cs_print(Sparse A, boolean brief)
    {
        return cs_print(A, brief, true);
    }
     ...
     */
    public static boolean cs_print(Sparse A, boolean brief, boolean matlab)
    {
