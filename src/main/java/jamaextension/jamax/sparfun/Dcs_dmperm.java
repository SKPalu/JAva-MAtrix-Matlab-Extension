...
public class Dcs_dmperm
{
    ...
    private static boolean cs_bfs(Sparse A, int n, int[] wi, int[] wj, int[] queue, int[] imatch, int imatch_offset,
     ...
     */
    public static Dcsd cs_dmperm(Sparse A, int seed)
    {
