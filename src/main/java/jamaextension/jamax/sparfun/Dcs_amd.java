...
public class Dcs_amd
{
     ...
     */
    public static int[] cs_amd(int order, Sparse A)
    {
        Sparse C, A2, AT;
        ...
        else if (order == 2)
        {
            ...
            C = (A2 != null) ? Dcs_multiply.cs_multiply(AT, A2) : null; /*
                                                                         * C=A'*A
                                                                         * with
                                                                         * no
                                                                         * dense
        ...
        while (nel < n) /* while (selecting pivots) do */
        {
            ...
            p = Cp[k];
            pk1 = (elenk == 0) ? p : cnz; /*
                                           * do in place if elen[elen_offset+k]
                                           * == 0
                                           */
            pk2 = pk1;
             ...
             * -----------------------------------------
             */
            mark = cs_wclear(mark, lemax, w, w_offset, n); /*
                                                            * clear w if
                                                            * necessary
                                                            */
            ...
            for (pk = pk1; pk < pk2; pk++) /* scan2: degree update */
            {
                ...
                else
                {
                    ...
                    next[next_offset + i] = hhead[hhead_offset + h]; /*
                                                                      * place i
                                                                      * in hash
                                                                      * bucket
                                                                      */
