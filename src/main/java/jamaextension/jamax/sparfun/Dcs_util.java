...
public class Dcs_util
{
     ...
     */
    public static Sparse cs_spalloc(int m, int n, int nzmax, boolean values, boolean triplet)
    {
        Sparse A = new Sparse(); /* allocate the Sparse struct */
     ...
     */
    public static boolean cs_sprealloc(Sparse A, int nzmax)
    {
        if (A == null)
            return (false);
        if (nzmax <= 0)
    ...
    public static boolean CS_MARKED(int[] w, int j)
    {
        return (w[j] < 0);
    }
     ...
     */
    public static boolean CS_CSC(Sparse A)
    {
     ...
     */
    public static boolean CS_TRIPLET(Sparse A)
    {
